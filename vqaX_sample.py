...
class VQAXEvalDataset(Dataset):
    ...
    def __init__(self, path, transform, tokenizer, max_seq_len, image_dir):
    ...
    def __getitem__(self, i):
        ...
        if 'train' in img_name:
            folder = osp.join(self.image_dir, 'train2014')
        else:
            folder = osp.join(self.image_dir, 'val2014')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--nle_data_val_path',
                        default='nle_data/VQA-X/vqaX_val.json')
